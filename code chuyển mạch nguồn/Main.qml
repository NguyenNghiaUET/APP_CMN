...
ApplicationWindow {
    ...
    width:  1440
    height: 900
    title: "CMN TESTING — HỆ THỐNG KIỂM TRA THIẾT BỊ"
    ...
    // ── Panel wrapper — dùng ColumnLayout, KHÔNG dùng default alias ───
    component PBox: Rectangle {
        property string hdr: ""
        property alias  body: bodyItem
        color: cPanel; border.color: cBorder; radius: 8; clip: true
        ColumnLayout {
            anchors.fill: parent; spacing: 0
            Rectangle {
                Layout.fillWidth: true; height: 30; color: cHdr
                Text { anchors.verticalCenter: parent.verticalCenter
                       anchors.left: parent.left; anchors.leftMargin: 12
                       text: parent.parent.parent.hdr            // PBox.hdr
                       color: cCyan; font.pixelSize: 12; font.bold: true }
            }
    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                CBtn { lbl: "AUTO"; bc: cPurple; width: 80; height: 32; fs: 12
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        ColumnLayout {
                            ...
                            // 3 fields — GridLayout tránh circular binding
                            GridLayout {
                ...
                ColumnLayout {
                    ...
                    ColumnLayout {
                        ...
                        ListView {
                            ...
                            model: ["VLS_ON","Bat_ON","Bat2_ON","Gen_ON",
                                    "VLS_BatON","VLS_BatOFF","MPSS_TBKT",
                                    "aCMD_ERM","CMD_PUMP","CCBH_in",
                        ...
                        CBtn { lbl: "Set Relay"; bc: cAccent; Layout.preferredWidth: 110; height: 30; fs: 11
                            onTapped: {
    ...
    Rectangle {
        ...
        // Fade-out khi đăng nhập thành công
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                Text {
                    text: "HỆ THỐNG KIỂM TRA THIẾT BỊ"
        ...
        // Delay nhỏ trước khi fade-out để user thấy thông báo OK
        Timer {
